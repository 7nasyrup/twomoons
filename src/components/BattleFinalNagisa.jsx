...
// COMPONENT
// ═══════════════════════════════════════════════════════════════════════════════
export default function BattleFinalNagisa({ onComplete, playBGM, stopBGM, playSE }) {
  // ─── Core State ───
          ...
          {allies.map(ally => {
            ...
            return (
              <div key={ally.id} className="relative flex flex-col items-center w-full">
                ...
                <div
                  // 味方のHPバーの位置
                  className={`w-20 lg:w-36 mb-1 lg:mb-2 z-20 relative ${ally.id === 'nagisa' ? 'translate-y-10 lg:translate-y-[10px]' : ''}`}>
                ...
                <div className={`relative flex items-center justify-center ${ally.id === 'nagisa' ? '' : 'top-2 left-2 lg:top-0 lg:left-0'}`}>
                  ...
                  {ally.id === 'nagisa' && (
                    <div className="absolute w-40 h-56 lg:w-48 lg:h-64 flex items-center justify-center pointer-events-none z-0">
                      <div className="relative w-full h-full lg:translate-y-[5px] -translate-x-24 lg:-translate-x-40">
                        <img
                  ...
                  >
                    ...
                    {isTargeted && !ally.isDead && (
                      <div className="absolute inset-0 pointer-events-none flex items-center justify-center z-40" style={{ transform: 'scale(0.85)' }}>
                    ...
                    <AnimatePresence>
                      {glintEffects.filter(g => g.targetId === ally.id).map(g => (
                        ...
                        >
                          <div style={{ transform: 'scale(0.85)' }} className="absolute inset-0 flex items-center justify-center pointer-events-none">
                            <div
          ...
          {enemies.map(enemy => {
            ...
            return (
              <div key={enemy.id} className="relative flex flex-col items-center w-full">
                <div
                  // 敵のHPバーの位置
                  className="w-20 lg:w-36 z-20 relative -translate-x-6 lg:translate-x-0 translate-y-7 lg:translate-y-6">
                  <div className="flex flex-col items-center">
                ...
                <div className="relative flex items-center justify-center -top-2 -left-8 lg:top-5 lg:left-0">
                  ...
                  <motion.div
                    ...
                    // 敵の立ち絵のサイズ
                    id={`char-${enemy.id}`}
                    className={`relative top-[55px] lg:top-0 w-44 h-56 lg:w-80 lg:h-96 flex items-center justify-center z-40 ${enemy.isDead ? 'opacity-30 grayscale'
