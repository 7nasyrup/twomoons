...
export default function BattleMidBossNagisa({ onComplete, playBGM, stopBGM, playSE }) {
  ...
  const handleNagisaUltimate = useCallback(() => {
    ...
    setSyncRate(0);
    setCounterAnim({ id: Date.now(), allyId: nagisa.id });
                ...
                <div className={`relative flex items-center justify-center ${ally.id === 'nagisa' ? '' : 'top-2 left-2 lg:top-0 lg:left-0'}`}>
                  ...
                  >
                    ...
                    {isTargeted && !ally.isDead && (
                      <div className="absolute inset-0 pointer-events-none flex items-center justify-center z-40" style={{ transform: 'scale(0.714)' }}>
                    ...
                    <AnimatePresence>
                      {glintEffects.filter(g => g.targetId === ally.id).map(g => (
                        ...
                        >
                          <div style={{ transform: 'scale(0.714)' }} className="absolute inset-0 flex items-center justify-center pointer-events-none">
                            <div
