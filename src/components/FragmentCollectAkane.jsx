...
// ─── メインコンポーネント ─────────────────────────────────────────────────────────
export default function FragmentCollectAkane({ onComplete }) {
      ...
      {!currentMessage && !isGameOver && (
        <div className="absolute top-6 left-0 right-0 z-30 flex items-start justify-between px-8 pointer-events-none">
          ...
          <div className="flex flex-col gap-2 items-end">
            ...
            <div id="fca-chip-counter" className="glass-panel px-6 py-3 rounded-full flex items-center gap-3">
            ...
            <div id="fca-file-counter" className="glass-panel px-6 py-3 rounded-full flex items-center gap-3">
