  ...
  return (
    <div className={`absolute inset-0 w-full h-full bg-[#090e17] overflow-hidden select-none z-50 flex flex-col font-orbitron ${shakeActive ? 'animate-battle-shake' : ''}`}>
      ...
      <div className="absolute inset-0 z-40 pointer-events-none">
        ...
        <div className="absolute bottom-10 right-8 md:bottom-12 md:right-12 pointer-events-auto flex items-end">
          <div className="flex flex-col items-end z-30">
            {/* Tech Panel for Sakura */}
            <div className="relative bg-[#060a12]/80 backdrop-blur-md border-r-4 border-cyan-500 shadow-[0_0_20px_rgba(34,211,238,0.2)] pl-8 pr-3 py-3 w-56 md:w-72 flex flex-col clip-path-sakura-panel skew-x-[-10deg]">
              
              <div className="flex items-center justify-between w-full mb-2 z-10 skew-x-[10deg]">
                <span className="font-orbitron font-black text-cyan-400 text-sm md:text-base tracking-[0.2em] drop-shadow-[0_0_8px_rgba(34,211,238,0.8)]">
                  SAKURA
                </span>
              ...
              <div className="w-full h-2 md:h-3 bg-black/90 border border-slate-700/50 relative overflow-hidden skew-x-[10deg] shadow-[inset_0_0_8px_rgba(0,0,0,1)]">
                <motion.div
