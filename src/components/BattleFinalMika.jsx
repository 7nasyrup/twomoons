              ...
              <div key={ally.id} className="relative flex flex-col items-center w-full">
                ...
                <div className={`relative flex items-center justify-center ${ally.id === 'nagisa' ? '' : 'top-2 left-2 lg:top-0 lg:left-0'}`}>
                    ...
                    <div className="absolute w-36 h-52 lg:w-48 lg:h-64 flex items-center justify-center pointer-events-none z-0">
                      <div className="relative w-full h-full -translate-y-[9px] lg:translate-y-[5px] -translate-x-24 lg:-translate-x-40">
                        <img
                          ...
                          alt="sakura"
                          className="w-full h-full object-contain drop-shadow-lg opacity-90 scale-[1.15] origin-bottom"
                        />
                        {/* 朔良の指示吹き出し */}
                        <AnimatePresence>
                          {sakuraSpeech && (
                  ...
                  >
                    ...
                    {ally.image ? (
                      <img src={ally.image} alt={ally.name} className={`w-full h-full object-contain relative z-10 -translate-y-6 scale-[1.35] origin-center ${ally.flashTimer > 0 ? 'animate-battle-hit-flash drop-shadow-[0_0_20px_rgba(248,113,113,0.8)]' : 'drop-shadow-lg'}`} />
                    ) : (
