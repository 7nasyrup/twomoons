...
function FCDialogueBox({ currentMessage, displayedText, isTyping, onNext }) {
  ...
  const hasSpeaker = currentMessage.speaker != null;
          ...
          {hasSpeaker && (
            <div className="absolute -top-5 left-6 md:left-10 h-[40px] flex items-center z-10">
              <div className="bg-white border border-slate-200 text-slate-800 text-sm font-bold tracking-[0.2em] px-6 py-2 rounded-xl shadow-[0_4px_15px_rgba(0,0,0,0.05)] min-w-[180px] h-full flex items-center justify-center gap-2">
                {isSystem && <Sparkles className="w-4 h-4 text-sky-500" />}
      ...
      {!currentMessage && !isGameOver && (
        <div className="absolute top-6 left-0 right-0 z-30 flex items-start justify-between px-8 pointer-events-none">
          ...
          <div className="flex flex-col gap-2 items-end">
            ...
            <div id="fcs-chip-counter" className="glass-panel px-6 py-3 rounded-full flex items-center gap-3">
            ...
            <div id="fcs-file-counter" className="glass-panel px-6 py-3 rounded-full flex items-center gap-3">
