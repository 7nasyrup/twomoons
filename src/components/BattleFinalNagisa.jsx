...
export default function BattleFinalNagisa({ onComplete, playBGM, stopBGM, playSE }) {
  ...
  const [guardCooldownTrigger, setGuardCooldownTrigger] = useState({ nagisa: 0 });
  ...
  const guardCooldownsRef = useRef({ nagisa: 0 });
              ...
              <div key={ally.id} className="relative flex flex-col items-center w-full">
                <div className="relative flex items-center justify-center">
                  ...
                  <motion.div
                    ...
                    ${ally.id === 'nagisa' ? 'w-[188px] h-[250px] md:w-[250px] md:h-[333px] translate-y-6 md:translate-y-12' : 'w-36 h-48 md:w-48 md:h-64 -translate-y-4'}
