export const scenarioData = [
    ...
    },
    {
        ...
        speaker: "朔良",
        role: "SAKURA",
        text: "私の身体が地面に叩きつけられる寸前、鋭い踏み込みの音と共に、強い力でその腕を引き戻された。焦げあとのある彼の服の袖をぎゅっと掴んだまま、私は荒い息を吐き出す。息を切らしながら私の身体を真っ直ぐに支えてくれたのは、ミカくんだった。"
    },
    {
        scene: "大学の敷地内",
        speaker: "朔良",
    ...
    },
    {
        ...
        speaker: "朔良",
        role: "SAKURA",
        text: "混乱する頭のまま、私はミカくんに手を引かれて再び走り出した。キャンパスのレンガ道を蹴り、冷たい夜風を切り裂いて進む。背後を振り返る余裕なんてなかったけれど、肌を刺すような冷たいプレッシャーで分かった。あの不気味な重圧──黒騎士が、確実に私たちのすぐ後ろまで迫ってきている。まるで、獲物を特定の場所へと追い詰める猟犬のように。"
    },
    {
        scene: "大学の敷地内",
        speaker: "朔良",
        role: "SAKURA",
        text: "心臓が破裂しそうなほどの恐怖の中、私たちは月科学エネルギー学部の研究棟へと滑り込み、エレベーターを待つ時間すら惜しんで階段を駆け上がった。最上階の廊下の突き当たり、明かりの漏れる部屋の前に辿り着き、ミカくんが勢いよくドアを開ける。中に飛び込んだ瞬間に急いで扉を閉め、内側から鍵をガチャンと回した。"
    },
    {
        scene: "教授の研究室",
        speaker: "朔良",
    ...
    },
    {
        ...
        speaker: "朔良",
        role: "SAKURA",
        text: "デスクに腰掛け、いつもと変わらない飄々とした様子で文庫本を閉じたのはヒルミ教授だった。外のキャンパスでは、キメラや黒騎士が暴れ回り、悲鳴が響き渡る凄惨な状況になっているというのに、落ち着き払っている。その温度差に、私はたまらず教授へと詰め寄った。"
    },
    {
        scene: "教授の研究室",
        speaker: "朔良",
    ...
    },
    {
        ...
        speaker: "朔良",
        role: "SAKURA",
        text: "ミカくんは何か言いたげな顔をして、一瞬だけ唇を噛んだ。お父さんのこと、自分の身体のこと──彼の脳裏にどんな想いが過ったのか、今の私には分からない。けれど彼はそれ以上何も語らず、翻ってそのままロケットの搭乗口へと足を進め、中へと乗り込んでいってしまった。"
    },
    {
        scene: "教授の研究室",
        speaker: "朔良",
