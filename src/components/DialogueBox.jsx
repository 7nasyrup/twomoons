    ...
    <AnimatePresence>
      ...
      >
        ...
        <div className="absolute bottom-0 w-full flex flex-col pointer-events-none items-center">
          ...
          <div 
            className="w-[90vw] max-md:w-[88%] max-w-[1100px] max-md:max-w-[1000px] mb-[8vh] max-md:mb-[4vh] cursor-pointer pointer-events-auto relative mt-[4vh] flex flex-col items-center"
          >
            ...
            <div className="w-full relative shadow-[0_10px_40px_rgba(0,0,0,0.3)] rounded-xl overflow-hidden border-b-[0.8vh] border-[#4dd0e1] flex flex-col">
              ...
              <div className="bg-white w-full h-[22vh] min-h-[22vh] max-h-[22vh] max-md:h-[28vh] max-md:min-h-[28vh] max-md:max-h-[28vh] flex-none overflow-hidden p-[4vh] max-md:pb-[6vh] pb-[4vh] relative">
                <p className="m-0 text-slate-800 text-[2.8vh] max-md:text-[3.3vh] leading-[1.8] font-noto tracking-wide whitespace-pre-line font-medium">
            ...
            <div className="absolute -bottom-[1.5vh] max-md:-bottom-[2vh] right-[6vw] max-md:right-[6%] flex gap-[0.8vh] max-md:gap-[1.5vh] z-20">
              <HudButton icon={<Save className="w-[2.2vh] h-[2.2vh] max-md:w-[2.5vh] max-md:h-[2.5vh]" />} label="SAVE" onClick={onSave} />
              <HudButton icon={<FolderOpen className="w-[2.2vh] h-[2.2vh] max-md:w-[2.5vh] max-md:h-[2.5vh]" />} label="LOAD" onClick={onLoad} />
              <HudButton icon={<SkipForward className="w-[2.2vh] h-[2.2vh] max-md:w-[2.5vh] max-md:h-[2.5vh]" />} label="SKIP" onClick={onToggleSkip} active={skipMode} />
              <HudButton icon={<BookOpen className="w-[2.2vh] h-[2.2vh] max-md:w-[2.5vh] max-md:h-[2.5vh]" />} label="LOG" onClick={onOpenLog} />
              <HudButton icon={<FastForward className="w-[2.2vh] h-[2.2vh] max-md:w-[2.5vh] max-md:h-[2.5vh]" />} label="AUTO" onClick={onToggleAuto} active={autoMode} />
            </div>
...
function HudButton({ icon, label, onClick, active }) {
  return (
    <button
      ...
      className={`flex items-center gap-[0.8vh] max-md:gap-[1vh] px-[2vh] max-md:px-[2.5vh] py-[0.8vh] max-md:py-[1vh] rounded-full text-[1.6vh] max-md:text-[1.8vh] font-bold tracking-widest font-noto
