export const scenarioData = [
    ...
    },
    {
        speaker: "私（朔良）",
        role: "UNADAPTED",
        text: "だから、あの強烈な猛攻の中でも、彼は的確に回避の指示が出せたのだ。相手の思考をダイレクトに読み解く、彼の持つ精神透視の異能。それは戦闘においては無敵の力かもしれないけれど、同時に、悍ましい化け物の思考まで脳内に強制的に流れ込んでくるという、あまりにも残酷な暴力のはずだった。"
    },
    {
        speaker: "凪砂",
        role: "NAGISA",
        text: "「便利だって思うだろ？…この力は制御できない。つまり…勝手に流れてくるんだよ。他の思考が。望んでもいないのに、有象無象のどす黒い本音も、化け物の殺意も、ぜんぶ強制的に脳みそへ注ぎ込まれる。……僕の頭はね、ずっとうるさくて、壊れそうなんだ」"
    },
    {
        speaker: "私（朔良）",
        role: "UNADAPTED",
    ...
    },
    {
        speaker: "私（朔良）",
        role: "UNADAPTED",
        text: "私の問いかけに対し、狭いラックの隙間に重苦しい沈黙が流れた。遠くでガレキを壊しながら迫ってくる黒騎士の足音が、心臓に悪いリズムで響いている。凪砂さんはゆっくりと視線を動かし、焦点の定まらない瞳で、じっと私の顔を見つめた。"
    },
    {
        speaker: "凪砂",
        role: "NAGISA",
    ...
    },
    {
        speaker: "私（朔良）",
        role: "UNADAPTED",
        text: "その言葉が、私の胸にすとんと落ちてきた。これまで彼が、時に強引に距離を縮めてきたり、私を絶対に手放そうとしなかった本当の理由。完璧な笑顔の裏で、他人のどす黒い本音の嵐に晒され、頭を焼き尽くされそうになっていた彼にとって──私の隣は、唯一訪れる「完全な静寂の避難所」だったのだ。彼が私に執着していた理由の真実に、私は今、ようやく合点がいった。"
    },
