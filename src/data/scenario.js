export const scenarioData = [
    ...
    },
    {
        ...
        speaker: "私（朔良）",
        role: "UNADAPTED",
        text: "低く、耳に心地よい声が頭上から降ってくる。 抱きとめられるようにしてその胸に飛び込んでしまった私は、慌てて顔を上げた。端正な顔立ちに、完璧に計算されたような優しい笑みを浮かべた青年──凪砂さんだった。"
    },
    {
        scene: "大学の敷地内",
        speaker: "私（朔良）",
    ...
    },
    {
        ...
        speaker: "私（朔良）",
        role: "UNADAPTED",
        text: "凪砂さんは私の手を引いて力強く走り出した。睦則や他の人の姿が見えないことを聞こうとしようとしたけど、そんな暇を与えられないまま引っ張られてしまう。 けれど、走るスピードが上がるにつれて、私の腕を掴む彼の手の力が強くなり、私はなんとも言えない不安を覚えた。"
    },
    {
        scene: "大学の敷地内",
        speaker: "私（朔良）",
    ...
    },
    {
        ...
        speaker: "私（朔良）",
        role: "UNADAPTED",
        text: "乱暴にドアを閉めて鍵をかける。 たどり着いた教授の研究室。 静まり返った室内には、無数のモニターが青白い光を放ち、部屋の中央には信じられないほど巨大な、金属製のハッチが口を開けていた。 そこには白衣を羽織り、眼鏡の奥で相変わらず本心の読めない薄笑いを浮かべたヒルミ教授が、静かにデスクに腰掛けていた。",
    ...
    },
    {
        ...
        speaker: "私（朔良）",
        role: "UNADAPTED",
        text: "部屋の奥から、いつもと変わらない白衣を羽織り、眼鏡の奥の瞳を細めたヒルミ教授が歩み寄ってきた。 外の惨劇や追っ手の恐怖から、ようやく彼のもとへ逃げ込めた安堵で膝が震える。しかし、教授は私たちの乱れた息を気にする風でもなく、部屋の中央にある巨大なハッチ──いや、地下へと続く『ロケット』の搭乗口を厳しい目で見つめた。その手元にある管制モニターには、カウントダウンの赤い数字が冷酷に刻まれている。",
    ...
    },
    {
        ...
        action: "SHOW_NAGISA_RIGHT"
    },
    {
        scene: "教授の研究室",
        speaker: "私（朔良）",
        role: "UNADAPTED",
        text: "朔良の隣で、凪砂さんが冷徹な声を響かせた。 腕を組み、教授を真っ直ぐに見据えるその態度は、どこまでも冷静。けれど、有無を言わせない断固とした拒絶の意志が、その鋭い瞳の奥に宿っている。 しかし、デスクの向こうに佇む教授の背中は、微塵も揺るがなかった。"
    },
    {
        scene: "教授の研究室",
        speaker: "ヒルミ教授",
    ...
    },
    {
        ...
        speaker: "私（朔良）",
        role: "UNADAPTED",
        text: "白衣のポケットに手を入れ、静かに、けれど逃げ道を塞ぐような重みのある声で教授が諭す。 その頑なな態度に、凪砂さんは「はぁ……」と深いため息をつき、大袈裟に肩をすくめてみせた。隠そうともしない、ひどく面倒くさそうな顔だ。"
    },
    {
        scene: "教授の研究室",
        speaker: "ヒルミ教授",
