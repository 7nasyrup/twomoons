  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <div className="w-full max-w-[1200px] px-4 md:px-16 mb-8 md:mb-12 cursor-pointer pointer-events-auto relative mt-8 flex flex-col items-center" onClick={onNext}>
          <div className="w-full relative shadow-[0_10px_40px_rgba(0,0,0,0.3)] rounded-xl overflow-hidden border-b-8 border-[#4dd0e1] flex flex-col">
            ...
            <div className="bg-white w-full h-[140px] min-h-[140px] max-h-[140px] flex-none overflow-hidden p-8 pb-12 relative">
              <p className="m-0 text-slate-800 text-lg md:text-xl leading-[2.2] font-noto tracking-wide whitespace-pre-line font-medium">
                {displayedText}
                {isTyping && <motion.span className="inline-block w-2.5 h-4 bg-[#00e5ff] ml-2 align-middle opacity-80" animate={{ opacity: [1, 0.2] }} transition={{ duration: 0.6, repeat: Infinity, ease: "linear" }} />}
              </p>
              {!isTyping && (
                <motion.div className="absolute bottom-6 right-8 flex items-center text-[#4dd0e1]" animate={{ x: [0, 8, 0] }} transition={{ duration: 0.8, repeat: Infinity, ease: "easeInOut" }}>
