...
// COMPONENT
// ═══════════════════════════════════════════════════════════════════════════════
export default function BattleSystemPlot2({ onComplete, playBGM, stopBGM, playSE }) {
  // ─── Core State ───
              ...
              <div key={ally.id} className="relative flex flex-col items-center w-full">
                <div className="relative flex items-center justify-center">
                  ...
                  <motion.div
                    ...
                    ${ally.id === 'nagisa' ? 'w-[90px] h-[120px] lg:w-[180px] lg:h-[230px]' : 'w-[125px] h-[187px] lg:w-48 lg:h-64 translate-y-32 lg:-translate-y-4'}
            ...
            return (
              <div key={enemy.id} className="relative flex flex-col items-center w-full">
                ...
                <div className="relative flex items-center justify-center">
                  ...
                  <motion.div
                    id={`char-${enemy.id}`}
                    className={`relative w-[230px] h-[307px] -translate-y-32 lg:translate-y-0 lg:w-80 lg:h-96 flex items-center justify-center z-40 ${enemy.isDead ? 'opacity-30 grayscale'
