...
const OBJECT_DETAILS = {
  ...
  photo: {
    messages: [
      ...
      { role: 'narrative', text: `父が残した言葉。私は昔から歌うことが好きで、友達の前でもよく自分の歌を披露していた。` },
      { role: 'narrative', text: `けれど”誰かを導く”なんて…いったいどういう意味なのかは分からない。それこそ、本人がいれば、真意を聞くことができたのだけど。` },
      { role: 'SAKURA', speaker: '朔良', text: `「…お父さん。寂しいよ。」` },
    ]
  },
};
