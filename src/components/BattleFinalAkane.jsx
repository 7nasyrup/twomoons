...
// Turn order
const TURN_ORDER = ['akane', 'enemy1', 'enemy2', 'enemy3'];
...
const getCharInfo = (id) => {
  const map = {
    ...
    enemy2: { name: 'キメラ4', image: '/character/kimera4.png', isAlly: false },
    enemy3: { name: 'キメラ5', image: '/character/kimera5.png', isAlly: false },
  };
            ...
            {(() => {
              ...
              return (
                ...
                >
                  ...
                  <img src={enemy1.image} alt={enemy1.name} className={`w-full h-full object-contain scale-[0.85] -translate-y-12 drop-shadow-[0_0_15px_rgba(244,63,94,0.3)] ${enemy1.isStunned ? 'opacity-70 grayscale-[50%]' : ''}`} />
                </motion.div>
              );
            })()}
