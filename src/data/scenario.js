export const scenarioData = [
    ...
    },
    {
        ...
        speaker: "私（朔良）",
        role: "UNADAPTED",
        text: "掴まれた腕の痛みに耐えながら、私は必死に声を張り上げ、自分が通う月科学エネルギー学部の研究棟へと凪砂さんを案内した。背後から迫る黒騎士の凄まじいプレッシャーに背中を押されるようにして、私たちは廊下を駆け抜け、目的の部屋へと滑り込む。"
    },
    {
        scene: "教授の研究室",
        speaker: "私（朔良）",
        role: "UNADAPTED",
        text: "乱暴にドアを閉めて鍵をかける。 たどり着いた教授の研究室。 静まり返った室内には、無数のモニターが青白い光を放ち、部屋の中央には信じられないほど巨大な、金属製のハッチが口を開けていた。",
    ...
    },
    {
        ...
        speaker: "私（朔良）",
        role: "UNADAPTED",
        text: "「私についても、心配は無用さ」──教授のその言葉が最後の警告だったかのように、私たちが乗り込んだ直後、重厚なハッチが金属音を立てて完全に閉鎖された。"
    },
    {
        scene: "ロケット内部",
        speaker: "私（朔良）",
    ...
    },
    {
        ...
        speaker: "私（朔良）",
        role: "UNADAPTED",
        text: "ひどく気まずい空気が、狭い機内に充満していく。"
    },
    {
        scene: "ロケット内部",
        speaker: "私（朔良）",
        role: "UNADAPTED",
        text: "隣に座る凪砂さんの横顔を盗み見ながら、私は押し潰されそうな不安を抱えていた。"
    },
    {
        scene: "ロケット内部",
        speaker: "私（朔良）",
    ...
    },
    {
        ...
        speaker: "私（朔良）",
        role: "UNADAPTED",
        text: "いつだって完璧な笑顔で周囲を魅了しているけれど、ふとした瞬間にこういう不気味なまでの冷淡さが顔を出す。前々から、それこそ一番最初に出会った時から薄々そう思ってはいたけれど──この世界の崩壊を前にしても、彼の態度はあまりにも他人事のようだった。"
    },
    {
        scene: "ロケット外部",
        speaker: "凪砂",
    ...
    },
    {
        ...
        speaker: "私（朔良）",
        role: "UNADAPTED",
        text: "私の肩に触れるか触れないかの距離から、彼はすっと身を起こした。先ほどまでの、吐息が届くほどの至近距離が嘘のように、その足取りは冷淡で容赦がない。私の心臓がまだうるさく鳴っていることなんて、最初から視界に入っていないみたいに。"
    },
    {
        scene: "ロケット外部",
        speaker: "凪砂",
    ...
    },
    {
        ...
        speaker: "私（朔良）",
        role: "UNADAPTED",
        text: "ピシャリと言い放たれ、私は言葉を失う。機密ファイルで読んだ、あの恐ろしい文字が脳裏をよぎった。──過負荷による感覚拒絶。彼は今、私の声すら、脳を焼き尽くす濁流の一部として苦しんでいるのかもしれない。そんな私の気遣いすら、今の彼には煩わしいだけのようだった。"
    },
    {
        scene: "制御室",
        speaker: "私（朔良）",
    ...
    },
    {
        ...
        speaker: "私（朔良）",
        role: "UNADAPTED",
        text: "慌てて駆け寄ろうとした私を、突然、強い衝撃が襲った。"
    },
    {
        scene: "最深部",
        speaker: "私（朔良）",
        role: "UNADAPTED",
        text: "凪砂さんが、遮二無二に私を引っ張り込み、無言で、狂ったような力で抱きついてきたのだ。"
    },
    {
        scene: "最深部",
        speaker: "私（朔良）",
    ...
    },
    {
        ...
        speaker: "私（朔良）",
        role: "UNADAPTED",
        text: "あまりの力に骨が軋みそうになる。息が詰まるほどの強引な抱擁。けれど、私に触れたその瞬間から、彼の荒い呼吸がすうっと静まっていくのが分かった。まるで、私の身体から流れ出る何かが、彼の脳内を狂わせていた濁流を瞬時に消し去っていくかのように──。"
    },
    {
        scene: "最深部",
        speaker: "私（朔良）",
    ...
    },
    {
        ...
        speaker: "私（朔良）",
        role: "UNADAPTED",
        text: "まるで、落ちているゴミを拾って捨てるかのように、凪砂さんは軽々と言ってのけた。世界を破滅に導いている元凶を前にして、その態度があまりにも淡々としていて、私はただ彼の横顔を見つめることしかできない。"
    },
    {
        scene: "研究所の最奥",
        speaker: "私（朔良）",
